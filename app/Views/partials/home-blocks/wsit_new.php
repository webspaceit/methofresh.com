<?php
// Homepage "New Arrivals" block.
// Expects: $title (string), $newArrivals (array of localized product rows).
?>
<section class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        <?php foreach ($newArrivals as $product) include views_path('partials/wsit_product-card.php'); ?>
    </div>
</section>